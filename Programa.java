...
public class Programa {
    ...
    public void alloc(String linha) {
        String[] argumentos = linha.split(",");

        int m = Integer.parseInt(argumentos[0]);
        int n = Integer.parseInt(argumentos[1]);
        ...
        for (k = 0; k <= n - 1; k++) {
            this.s++;
            M.add(s, 0);
            temp = Integer.parseInt(M.get(m + k).toString());
            M.set(s, temp);
        }
    }

    public void dalloc(String linha) {
        String[] argumentos = linha.split(",");
    ...
    public void returnvm() {
        this.i = Integer.parseInt(M.get(s).toString());
        this.s--;
    }
                                                                                    ...
                                                                                    if (linha[0].equals("JMP")) {
                                                                                        ...
                                                                                        if (linha[0].equals("JMPF")) {
                                                                                            ...
                                                                                            if (linha[0].equals("PRN")) {
                                                                                                ...
                                                                                                if (linha[0].equals("ALLOC")) {
                                                                                                    alloc(linha[1]);
                                                                                                } else {
                                                                                                    if (linha[0].equals("DALLOC")) {
                                                                                                        dalloc(linha[1]);
                                                                                                    } else {
                                                                                                        if (linha[0].equals("CALL")) {
                                                                                                            call(linha[1]);
                                                                                                        } else {
                                                                                                            if (linha[0].equals("RETURN")) {
                                                                                                                returnvm();
                                                                                                            } else {
                                                                                                            }
                                                                                                        }
